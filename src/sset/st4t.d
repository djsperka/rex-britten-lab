...
int fake_joy_dummy = 0;
int fake_joy_dummy_index = 0;
...
int joystick_value()
{
	...
	else 
	{
		...
		else if (fake_joy_dummy)
		{
			value = djoy[fake_joy_dummy_index++];
			if (fake_joy_dummy_index == sizeof(djoy)/sizeof(int)) fake_joy_dummy_index = 0;
		}
		else 
		{
...
"Dummy_joy", &fake_joy_dummy, 0, NP, 0, ME_DEC,
NS,
};
