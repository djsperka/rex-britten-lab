/* $Id: st18af.d,v 1.8 2015/05/12 20:53:48 devel Exp $  */
...
int f_reward_holdoff = 200;			/* when on target, this is a delay before the first reward */
...
int my_exp_init()
{
	...
	set_times("fixpt_fail_timeout", (long)f_fix_timeout, -1);
...
int my_trial_done()
{
	...
	wd_cntrl(WIND0, WD_OFF);	/* stop analysis for eye window */
...
begin	first:
	...
	fixpt_fixate:
		code FIXCD
		time 500
		to fixpt_fail on +WD0_XY & eyeflag
